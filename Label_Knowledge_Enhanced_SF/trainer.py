    ...
    def train(self):
        ...
        for epoch in range(self.args.num_epochs):
            for train_data in self.train_datas:
                ...
                for step, batch in enumerate(tqdm(train_dataloader, desc=f'Train Epoch {epoch + 1}/{self.args.num_epochs}, Domain: {domain_name}')):
                    self.model.train()
                ...
                logger.info(f'Epoch {epoch + 1}, Domain {domain_name}, train_loss {train_loss / len(train_dataloader):.6f},    Evalution acc {acc:.4f}, recall {recall:.4f}, f1 {f1:.4f}')
